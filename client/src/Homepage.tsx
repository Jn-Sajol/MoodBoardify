  ...
  hover:from-blue-400 hover:to-blue-900 "
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        <FeatureCard
          ...
          description="Find the perfect music to match your mood."
        />
        <FeatureCard
          icon="🎬"
          title="Movie Recommendations"
          description="Get movie recommendations that fit your vibe."
        />
        <FeatureCard
          icon="📊"
          title="Mood Statistics"
          description="Track your moods and see trends over time."
        />
      </section>
